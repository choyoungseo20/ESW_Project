...
class ScoreCPlus:
    def __init__(self):
        ...
        self.pixel_map = [
            ...
            "aaeeeeeeeeeeeebbbffffeebbebbbbbbeeebgg..",
            ".aaeeeeeeeeeeebbffffeeeebebbbbbbeeebgg..",
            ".aaeeeeeeeeefbbffffefeeeeeeebbeeeeffbgg.",
            ".aaeeeeeeefffbbffeffffeeeeeebbeeffffbgg.",
            "..aaeeeefffffbbefffffffeeeeeeeffffffbgg.",
            "..aaceeffffffbbffffffffffeeeefffffffbgg.",
            "..ccfffffffhhhbbhhhhffffbeefffffffffbgg.",
            ".ccffffffhhhhhbbbhhhhhhbbhhfffffffffbgg.",
