...
class ScoreC:
    def __init__(self):
        ...
        self.pixel_map = [
            ...
            "aaeeeeeeeeeeeebbbffffeebbeeeeeeeeeebgg..",
            ".aaeeeeeeeeeeebbffffeeeebeeeeeeeeeebgg..",
            ".aaeeeeeeeeefbbffffefeeeeeeeeeeeeeffbgg.",
            ".aaeeeeeeefffbbffeffffeeeeeeeeeeffffbgg.",
